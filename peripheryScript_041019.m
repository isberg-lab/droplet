...
for j = 1:length(red_image_array)
    ...
    output_array{j, 15} = output_array{j, 7}/output_array{j, 10};
    output_array{j, 16} = output_array{j, 12}/output_array{j, 14};
...
output_table = cell2table(output_array, 'VariableNames', {'FileName'...
    ...
    'GreenPLITotal', 'GreenPLIAverage', 'PeriphCentRatioRed', ...
    'PeriphCentRatioGreen', 'RedRatio_over_GreenRatio'});
